...
export const executivePresenceQuestions: ExecutivePresenceQuestion[] = [
  {
    id: "q01",
    format: "situational",
    text: "Você está numa reunião que começa a perder o fio. Sua tendência mais natural é:",
    options: [
      { id: "q01_o1", text: "Trazer a conversa para uma definição objetiva, mesmo que ainda exista desconforto na sala.", traitKey: "direction" },
      { id: "q01_o2", text: "Reorganizar o sentido da conversa para que as pessoas enxerguem o que está em jogo.", traitKey: "influence" },
  ...
  },
  {
    id: "q02",
    format: "situational",
    text: "Você está falando e alguém te interrompe no meio do raciocínio. O que você faz?",
    options: [
      { id: "q02_o1", text: "Retoma a palavra e fecha o raciocínio sem pedir muito espaço.", traitKey: "direction" },
      { id: "q02_o2", text: "Usa uma frase curta e elegante para recuperar atenção sem romper o clima.", traitKey: "influence" },
      { id: "q02_o3", text: "Espera uma abertura mais segura para voltar ao ponto com menos exposição.", traitKey: "diplomacy" },
      { id: "q02_o4", text: "Recoloca o argumento com mais estrutura para reduzir ruído e ganhar legitimidade.", traitKey: "precision" }
    ]
  },
  {
    id: "q03",
    ...
    options: [
      { id: "q03_o1", text: "Tenho clareza da posição que quero defender e até onde vou ceder.", traitKey: "direction" },
      { id: "q03_o2", text: "Consigo conectar minha divergência ao resultado que o grupo quer proteger.", traitKey: "influence" },
      { id: "q03_o3", text: "Encontro um jeito de discordar sem parecer que estou criando atrito.", traitKey: "diplomacy" },
  ...
  },
  {
    id: "q04",
    format: "frequency",
    text: "Quando chega a hora de falar sobre salário ou promoção, sua energia vai primeiro para:",
    options: [
      { id: "q04_o1", text: "Definir o pedido com clareza e entrar na conversa sabendo o que quer.", traitKey: "direction" },
      { id: "q04_o2", text: "Construir uma narrativa de valor que mostre evolução, impacto e maturidade.", traitKey: "influence" },
      { id: "q04_o3", text: "Encontrar um tom que não comprometa a relação nem desperdice a oportunidade.", traitKey: "diplomacy" },
  ...
  },
  {
    id: "q05",
    format: "situational",
    text: "Uma ideia sua aparece numa apresentação como se tivesse vindo de outra pessoa. Você:",
    options: [
      { id: "q05_o1", text: "Recoloca sua autoria ali mesmo, sem rodeios.", traitKey: "direction" },
      { id: "q05_o2", text: "Narra a origem da ideia de um jeito que reposiciona sua contribuição sem criar cena.", traitKey: "influence" },
      { id: "q05_o3", text: "Escolhe uma conversa reservada para tratar isso sem transformar em conflito.", traitKey: "diplomacy" },
      { id: "q05_o4", text: "Recupera registros, contexto e sequência dos fatos antes de agir.", traitKey: "precision" }
    ]
  },
  {
    id: "q06",
    format: "frequency",
    text: "Quando precisa colocar um limite numa demanda, você concentra energia em:",
    options: [
      { id: "q06_o1", text: "Dizer com simplicidade o que cabe, o que não cabe e qual decisão precisa ser tomada.", traitKey: "direction" },
      { id: "q06_o2", text: "Mostrar que o limite protege prioridades maiores, não é resistência pessoal.", traitKey: "influence" },
      { id: "q06_o3", text: "Preservar a relação enquanto renegocia prazo, expectativa ou disponibilidade.", traitKey: "diplomacy" },
  ...
  },
  {
    id: "q07",
    format: "frequency",
    text: "Em momentos de pressão alta, o que as pessoas costumam esperar de você?",
    options: [
  ...
  },
  {
    id: "q08",
    format: "frequency",
    text: "Diante de um feedback que parece impreciso ou injusto, sua primeira reação é:",
    options: [
  ...
  },
  {
    id: "q09",
    format: "situational",
    text: "Você vai apresentar um projeto para lideranças seniores. O que domina sua preparação?",
    options: [
  ...
  },
  {
    id: "q10",
    format: "situational",
    text: "A conversa fica carregada e a tensão sobe. Sua primeira tendência é:",
    options: [
      { id: "q10_o1", text: "Cortar a ambiguidade e conduzir a conversa para uma definição.", traitKey: "direction" },
      { id: "q10_o2", text: "Reformular a mensagem para manter influência sem entrar em confronto aberto.", traitKey: "influence" },
      { id: "q10_o3", text: "Escutar mais um pouco para baixar a tensão antes de responder.", traitKey: "diplomacy" },
      { id: "q10_o4", text: "Voltar aos fatos para impedir que interpretações soltas dominem a conversa.", traitKey: "precision" }
    ]
  },
  {
    id: "q11",
    format: "agreement",
    text: "Em conversas com opiniões divergentes, eu costumo ganhar espaço quando:",
    options: [
  ...
  },
  {
    id: "q12",
    format: "frequency",
    text: "Ao defender uma entrega sua para lideranças, você sente mais necessidade de:",
    options: [
      ...
      { id: "q12_o3", text: "Reconhecer o que foi coletivo sem perder sua própria parte no resultado.", traitKey: "diplomacy" },
  ...
  },
  {
    ...
    options: [
      { id: "q13_o1", text: "Consigo escolher a alternativa mais forte e sustentar o movimento com convicção.", traitKey: "direction" },
  ...
  },
  {
    id: "q14",
    format: "frequency",
    text: "Quando precisa se posicionar em público, você se apoia mais em:",
    options: [
      ...
      { id: "q14_o4", text: "Estrutura lógica, domínio do conteúdo e preparo para perguntas difíceis.", traitKey: "precision" }
    ]
  },
  {
    id: "q15",
  ...
  },
  {
    id: "q16",
    format: "agreement",
    text: "Quando questionam minha recomendação na frente de outras pessoas, eu respondo melhor:",
    options: [
      { id: "q16_o1", text: "Reafirmando o ponto central sem enfraquecer minha posição.", traitKey: "direction" },
      { id: "q16_o2", text: "Transformando a objeção em uma oportunidade de alinhamento.", traitKey: "influence" },
      { id: "q16_o3", text: "Reconhecendo a preocupação antes de defender minha visão.", traitKey: "diplomacy" },
      { id: "q16_o4", text: "Explicando as premissas e dados que sustentam a conclusão.", traitKey: "precision" }
    ]
  },
  {
    id: "q17",
  ...
  },
  {
    id: "q18",
    format: "frequency",
    text: "Quando precisa pedir apoio ou recurso, você organiza o pedido a partir de:",
    options: [
  ...
  },
  {
    id: "q19",
    format: "situational",
    text: "Você percebe que está sendo subestimada numa reunião ou processo. Sua resposta mais provável é:",
    options: [
      { id: "q19_o1", text: "Ocupa mais espaço e coloca sua contribuição na mesa com firmeza.", traitKey: "direction" },
      { id: "q19_o2", text: "Reposiciona sua imagem por presença, narrativa e consistência.", traitKey: "influence" },
      { id: "q19_o3", text: "Constrói confiança aos poucos sem transformar em disputa aberta.", traitKey: "diplomacy" },
      { id: "q19_o4", text: "Demonstra preparo, entrega e consistência até a percepção mudar.", traitKey: "precision" }
    ]
  },
  {
    id: "q20",
